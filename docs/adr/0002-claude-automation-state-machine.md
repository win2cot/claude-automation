...
| **audit-log Issue** ([#59](https://github.com/win2cot/claude-automation/issues/59)) | 複数 Target を scan / audit する workflow の検知結果 | SM-L1 起動失敗 watchdog / SM-16 field audit / SM-17 反映漏れチェック |
...
- audit-log Issue [#59](https://github.com/win2cot/claude-automation/issues/59)(append-only, never close)— SM-15 で open(SM-L1 / SM-16 / SM-17 で使用)
